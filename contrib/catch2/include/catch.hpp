 ...
 * directly Copyright (c) 2020 Two Blue Cubes Ltd. All rights reserved.
 *
...
constexpr auto
operator"" _catch_sr(char const *rawChars, std::size_t size) noexcept
    -> Catch::StringRef
{
...
template<typename Fun, typename... Args>
CompleteType_t<ResultOf_t<Fun(Args...)>>
...
public:
  ...
  void
  registerReporter(std::string const &name, IReporterFactoryPtr const &factory);
