...
%fg l2d2
%out_format = strcat(batch_dir, 'continuity3_fg_l2_d2_t%d.dat');
%pde = continuity3_updated;
...
%fg l2d2
%out_format = strcat(batch_dir, 'continuity6_fg_l2_d2_t%d.dat');
%pde = continuity6_updated;
...
disp('last one');
%sg l4d3
out_format = strcat(batch_dir, 'continuity6_sg_l4_d3_t%d.dat');
pde = continuity6_updated;
pde.CFL=.1;
level = 4;
degree = 3;
