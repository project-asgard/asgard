...
element_table::element_table(int const dim, int const level, bool const full_grid) : size_{0} {}

//TODO forward lookup
int element_table::get_index(std::vector<int> const coords) const {
    return 0;
}
...
static fk::matrix permutations_leq(int const dims, int const n, bool const order_by_n)
{
