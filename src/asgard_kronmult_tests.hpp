...
struct kronmult_intputs{
    ...
    asgard::fk::vector<T*, asgard::mem_type::owner, asgard::resource::device> gpupX;
    asgard::fk::vector<T*, asgard::mem_type::owner, asgard::resource::device> gpupY;
    asgard::fk::vector<T*, asgard::mem_type::owner, asgard::resource::device> gpupA;
    #endif
};
