...
// gpu-enabled implicit time advance not yet implemented
  ...
  // Our default workspace size is 10GB - 12 GB DRAM on TitanV
  ...
  // if the code is built for that - and doesn't include the
  // batch sizes currently. so, you need to leave a GB or so
  // for those.
  //
