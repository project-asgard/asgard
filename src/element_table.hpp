...
// components. 
// - to build a sparse grid, we apply some rule to omit some of these permutations.
// currently, we cull level combinations whose sum is greater than the number of
// levels selected for the simulation.   
// --------------------------------------------------------------------------
