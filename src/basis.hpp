...
template<typename P>
fk::matrix<P> apply_left_fmwt_transposed(fk::matrix<P> const fmwt,
                                         fk::matrix<P> const coefficient_matrix,
                                         int const kdeg, int const num_levels);
template<typename P>
...
apply_left_fmwt_transposed(fk::matrix<double> const, fk::matrix<double> const,
                           int const, int const);
...
extern template fk::matrix<double>
apply_right_fmwt_transposed(fk::matrix<double> const, fk::matrix<double> const,
                            int const, int const);
extern template fk::matrix<float>
apply_right_fmwt_transposed(fk::matrix<float> const, fk::matrix<float> const,
                            int const, int const);
