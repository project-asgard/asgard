...
rotg(float *a, float *b, float *c, float *s, resource resrc);
extern template void
rotg(double *a, double *b, double *c, double *s, resource resrc);

extern template float nrm2(int *n, float *x, int *incx, resource const resrc);
extern template double nrm2(int *n, double *x, int *incx, resource const resrc);
...
extern template void
scal(int *n, int *alpha, int *x, int *incx, resource const resrc);
...
extern template void
batched_gemv(float **const &a, int *lda, char const *transa, float **const &x,
             float **const &y, int *m, int *n, float *alpha, float *beta,
             int *num_batch, resource const resrc);

extern template void
batched_gemv(double **const &a, int *lda, char const *transa, double **const &x,
             double **const &y, int *m, int *n, double *alpha, double *beta,
             int *num_batch, resource const resrc);
...
extern template void getrs(char *trans, int *n, int *nrhs, double *A, int *lda,
