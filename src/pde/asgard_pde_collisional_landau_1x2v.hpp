...
template<typename P>
class PDE_collisional_landau_1x2v : public PDE<P>
{
public:
...
private:
  ...
  inline static const partial_term<P>
      e2_pterm_x{pt_div_periodic, flux_type::downwind, PDE<P>::gfunc_neg1};
  ...
  inline static const
  partial_term<P> pt_div_v_up{pt_div_dirichlet_zero, flux_type::upwind, PDE<P>::gfunc_neg1};

  inline static term<P> const div_v_up{"", pt_div_v_up, imex_flag::imex_explicit};

  inline static std::vector<term<P>> const terms_ex_3{Emass_pos, div_v_up, I_ex};
  ...
  inline static const
  partial_term<P> pt_div_v_dn{pt_div_dirichlet_zero, flux_type::downwind, PDE<P>::gfunc_neg1};

  inline static term<P> const div_v_dn{"", pt_div_v_dn, imex_flag::imex_explicit};

  inline static std::vector<term<P>> const terms_ex_4{Emass_neg, div_v_dn, I_ex};
