...
// ---------------------------------------------------------------------------
template<typename P>
class PDE_advect_blob_3d : public PDE<P>
{
public:
  PDE_advect_blob_3d(parser const &cli_input)
...
private:
  ...
  inline static const partial_term<P> partial_term_0_d0 = partial_term<P>(
      coefficient_type::grad, g_func_0, flux_type::downwind,
      boundary_condition::periodic, boundary_condition::periodic);

  inline static const partial_term<P> partial_term_0_d1 = partial_term<P>(
      coefficient_type::mass, g_func_identity, flux_type::downwind,
      boundary_condition::periodic, boundary_condition::periodic);

  inline static const partial_term<P> partial_term_0_d2 = partial_term<P>(
      coefficient_type::mass, g_func_identity, flux_type::downwind,
      boundary_condition::periodic, boundary_condition::periodic);
