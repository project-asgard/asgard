...
// w(s) == d/ds g3(s) f [grad, g3(s) = -1, BCL= D, BCR=D]
  ...
  inline static std::vector<vector_func<P>> const boundary_left_ = {common.bc_func_0, common.bc_func_z, common.bc_func_s};

  inline static std::vector<vector_func<P>> const boundary_right_ = {common.bc_func_v, common.bc_func_z, common.bc_func_s}; 
 
  inline static partial_term<P> const pterm_2_ =
      partial_term<P>(coefficient_type::grad, g_func_identity, flux_type::downwind, 
      boundary_condition::dirichlet, boundary_condition::dirichlet,
      homogeneity::inhomogeneous, homogeneity::inhomogeneous,
      boundary_left_, common.bc_time, boundary_right_, common.bc_time);
  ...
  inline static std::vector<term<P>> const termsS0_ = {term0_v_, term0_z_, term0_s_};
...
// w(s) == g3(s) f [mass, g3(s) = -dB/ds/B, BCL= D, BCR=D]
  ...
  inline static std::vector<term<P>> const termsS1_ = {termB0_v_, termB0_z_, termB0_s_};
...
//   r(z) == d/dp g4(z) f(z)   [grad, g3(p) = 1,      BCL=N,BCR=N]
  ...
  inline static partial_term<P> const pterm_C2_ =
      partial_term<P>(coefficient_type::grad, g_func_C2, flux_type::upwind, boundary_condition::dirichlet, boundary_condition::neumann);

  inline static partial_term<P> const pterm_C3_ =
      partial_term<P>(coefficient_type::grad, g_func_identity, flux_type::downwind, boundary_condition::neumann, boundary_condition::dirichlet, 
      homogeneity::inhomogeneous, homogeneity::inhomogeneous,
      boundary_left_, common.bc_time, boundary_right_, common.bc_time);
  ...
  {
    ignore(time);
    return std::pow(x, 3) * common.species_a.M * common.NU_S({x})(0)/(common.species_a.M + common.species_b.M)  ;
  }

  inline static partial_term<P> const pterm_V0_1_ =
      partial_term<P>(coefficient_type::grad, g_func_V0_1, flux_type::downwind, boundary_condition::neumann, boundary_condition::dirichlet, 
      homogeneity::inhomogeneous, homogeneity::inhomogeneous,
      boundary_left_, common.bc_time, boundary_right_, common.bc_time);
...
// r(v) = d/dv(g3(v)f)       [grad, g3(v) = 1, BCL=N, BCR=N]
  ...
  inline static partial_term<P> const pterm_V1_1_ =
      partial_term<P>(coefficient_type::grad, g_func_V1_1, flux_type::upwind, boundary_condition::dirichlet, boundary_condition::neumann);

  inline static partial_term<P> const pterm_V1_2_ =
      partial_term<P>(coefficient_type::grad, g_func_identity, flux_type::downwind, boundary_condition::neumann, boundary_condition::dirichlet, 
      homogeneity::inhomogeneous, homogeneity::inhomogeneous,
      boundary_left_, common.bc_time, boundary_right_, common.bc_time);
  ...
  inline static term_set<P> const terms_ = {termsV0_, termsV1_, termsC_, termsS0_, termsS1_};

// -- exact sol -- 

// define exact soln functions
inline static std::vector<vector_func<P>> const exact_vector_funcs_ = {
      common.exact_solution_v, common.exact_solution_z, common.exact_solution_s};
